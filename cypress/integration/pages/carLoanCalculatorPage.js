const page = {
    literals: {
        header1: 'How much can I afford?',
        header2: 'Estimate monthly payment or maximum car price with a loan calculator',
    ...
    actions: {
        validateHeader1() {
            cy.get(page.elements.header1, { timeout: 72000 }).invoke('text').then((text) => {
                cy.wrap(text).should('eq', page.literals.header1)
            })
        },
        validateHeader2() {
            cy.get(page.elements.header2, { timeout: 72000 }).invoke('text').then((text) => {
        ...
        assertRebuildingButton() {
            cy.get(page.elements.button).eq(0).click().should('have.attr', 'aria-selected', 'true')
        },
        assertGoodButton() {
            cy.get(page.elements.button).eq(1).click().should('have.attr', 'aria-selected', 'true')
        },
        assertExcellentButton() {
            cy.get(page.elements.button).eq(2).click().should('have.attr', 'aria-selected', 'true')
        },
        ...
        assert24moButton() {
            cy.get(page.elements.button).eq(3).click().should('have.attr', 'aria-selected', 'true')
        },
        assert36moButton() {
            cy.get(page.elements.button).eq(4).click().should('have.attr', 'aria-selected', 'true')
        },
        assert48moButton() {
            cy.get(page.elements.button).eq(5).click().should('have.attr', 'aria-selected', 'true')
        },
        assert60moButton() {
            cy.get(page.elements.button).eq(6).click().should('have.attr', 'aria-selected', 'true')
        },
        assert72moButton() {
            cy.get(page.elements.button).eq(7).click().should('have.attr', 'aria-selected', 'true')
        },
